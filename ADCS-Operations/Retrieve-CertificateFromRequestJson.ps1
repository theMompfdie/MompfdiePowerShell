function Request-CertificateViaCertreq {
    <#
    .SYNOPSIS
    Submits a certificate signing request (CSR) to an internal Microsoft CA using certreq.

    .DESCRIPTION
    Sends a CSR file to a certificate authority (CA) using certreq.exe and specifies the certificate template.
    Supports both issued and pending certificate workflows. If the request is pending, a JSON file is created
    containing all required metadata to retrieve the certificate later.

    .PARAMETER CsrPath
    Path to the .csr file to be submitted.

    .PARAMETER CAConfig
    The CA configuration string, typically in the format 'hostname\CAName'.

    .PARAMETER CertTemplate
    The name of the certificate template to request.

    .PARAMETER OutputDirectory
    The directory where output files (cert, JSON) should be stored. Defaults to the CSR's directory.

    .PARAMETER CertOutputFile
    Optional filename for the resulting certificate. If omitted, defaults to <basename>.cer in the output directory.

    .EXAMPLE
    Request-CertificateViaCertreq -CsrPath 'C:\Certs\web01.csr' -CAConfig 'CA01\My-CA' -CertTemplate 'WebServer'

    .EXAMPLE
    Request-CertificateViaCertreq -CsrPath 'C:\Certs\web02.csr' -CAConfig 'CA01\My-CA' -CertTemplate 'WebServer' -CertOutputFile 'web02.cer'
    #>
    ...
    if ($null -ne $requestId) {
        ...
        Write-Host "📝 Request tracking file created: $jsonPath"
        return $jsonPath
    }
    elseif (Test-Path $certOutput) {
        Write-Host "✅ Certificate was issued immediately: $certOutput"
        return $certOutput
    }
    else {
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU8kcKKX610OEKyH+P2X1+wqx7
# J9mggiT/MIIFjTCCBHWgAwIBAgIQDpsYjvnQLefv21DiCEAYWjANBgkqhkiG9w0B
...
# CisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBS19/y7
# z1WnCgYk2231bhoYF6NH4DANBgkqhkiG9w0BAQEFAASCAQA2DoGs3Jer3PwU51wn
# BZ0u9FJnz5HnsPcfkmUvzjDhTxECy14TnAauZcDpC4eHQe3q4NHwIx2FlGvYSrv/
# T/YQOGCcs6O2ARNIDh2V6iYd49ORf+ZKb6HqVtb2QUnYIzfS5qKU2EKCShQPSBa0
# 7lpjrL19YTTOW0ornsCx7JhLNUO7sguYO1vdlIjE606gVE9GkyG2M0EOGKG9J1y3
# x4DI/LpFn2mGVQaXqTtBtDwZssDFGK7/a86EBh7yJ1kehuJnq85p0vXSeXtCvBZc
# xzwWOu9fDXkuQWn+qYFgpAKnLj56FIpQpOW/ci07izOaRt3DJgWYYDNJ2DuTtPnc
# l6kioYIDIDCCAxwGCSqGSIb3DQEJBjGCAw0wggMJAgEBMHcwYzELMAkGA1UEBhMC
...
# 9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTI1MDUxMjE3MjgxOVowLwYJKoZIhvcNAQkE
# MSIEINt7cSH++Qbdb5dOy8kqayECGkpedHXOkno8YwzW90PMMA0GCSqGSIb3DQEB
# AQUABIICAE5+uCYML5bS48AuqMDTtpOMg1hm4fJhKVKr9pwTSlgMS0Zn6bwbn7jv
# IHxV3WXXWwvo1tAa7GbElkQK2q8OKHZ9DVit/eCDLUuQ3uSWOPuwMn0Y7mk4caWR
# 5XXn9isCcWwzxCDy5HsVpMmI6y2Io8OlsCjFjxgYIXA9KZ2tIVX62vrVhHwazVj/
# 6KkS2uBErDzU5b+8zmTME7ofEVdbWbS0d5NZvDXlnrGH6/aDzqIlnq6N9mzMhSKs
# kV58W9oX8aBjg2mfQ7fKVzk/reK5+T9r29JkJvZk0zdXm4T9qhPOjro8sYMMM+sm
# XFXiYV8SP6ucq7BAmdDYCFQYyO/IEyxV+rT6KZphmRKaEYH9F4PKhnKc4Lf+lK0g
# rVTkvmNQEEwwtOJXQcauH2gQ1ntsdgWVcPwt3LIkzqtkVG3ULw2r1KU56D4RCnJD
# y2QL/jPC/Dwuee9pBUvN+8E/p/G1zeLxGgShaxVav5AupJBjQr9TqrliSmoSgkmO
# KHsktng85vX0ymxhnmlnlJNdXMtRW7IK47sTVZh/cOf+quNS6Z1A2cJspOBBk0SZ
# vZ7AzhmP+Ex+O4eipMdMIJHdP4wW0SoNZ1pM8cuOb86V2joMWyJWFCKDUksENOnW
# uhD9S4ibA/KfRSMLYLlEA3rz1e1BZyguLTuSTdLYwuaE44q4B2mv
