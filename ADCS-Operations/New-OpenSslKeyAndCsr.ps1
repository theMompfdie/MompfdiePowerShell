function New-OpenSslKeyAndCsr {
    <#
    .SYNOPSIS
    Generates a private RSA key and a Certificate Signing Request (CSR) using OpenSSL.

    .DESCRIPTION
    This function creates a 4096-bit RSA private key and a CSR based on the specified OpenSSL .cnf configuration file.
    The generated files will be saved in the same directory as the configuration file unless a custom output directory is specified.

    .PARAMETER ConfigPath
    Path to the OpenSSL configuration (.cnf) file that defines the subject and SAN values.

    .PARAMETER OutputDirectory
    Directory where the key and CSR will be saved. Defaults to the directory of the .cnf file.

    .PARAMETER OpenSslPath
    Full path to the OpenSSL executable. Defaults to standard Windows OpenSSL installation path.

    .EXAMPLE
    New-OpenSslKeyAndCsr -ConfigPath 'C:\Certificates\web01.cnf'

    .EXAMPLE
    New-OpenSslKeyAndCsr -ConfigPath 'C:\Certs\myapp.cnf' -OutputDirectory 'C:\Certs\Output' -OpenSslPath 'C:\Tools\OpenSSL\bin\openssl.exe'
    #>
    ...
    param (
        ...
        [string]$OutputDirectory = (Split-Path -Path $ConfigPath),
        [string]$OpenSslPath = 'C:\Program Files\OpenSSL-Win64\bin\openssl.exe'
    )

    $baseName = [IO.Path]::GetFileNameWithoutExtension($ConfigPath)
    $keyPath = Join-Path $OutputDirectory "$baseName.key"
    $csrPath = Join-Path $OutputDirectory "$baseName.csr"

    & $OpenSslPath genrsa -out $keyPath 4096
    & $OpenSslPath req -new -config $ConfigPath -key $keyPath -out $csrPath    

    if ((Test-Path $keyPath) -and (Test-Path $csrPath)) {
        Write-Host "✅ Private Key: $keyPath"
        Write-Host "✅ CSR:         $csrPath"
        return @{ Key = $keyPath; CSR = $csrPath }
    } else {
        throw "❌ Failed to generate Key or CSR."
    }
}
# SIG # Begin signature block
# MIIrcwYJKoZIhvcNAQcCoIIrZDCCK2ACAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU8jLMN6wiBPPeUkHlJddNUvrV
# HBSggiT/MIIFjTCCBHWgAwIBAgIQDpsYjvnQLefv21DiCEAYWjANBgkqhkiG9w0B
...
# CisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBTtZrmQ
# MH9++HEMqa6Afz59J22XQDANBgkqhkiG9w0BAQEFAASCAQBw7xISK02ELruU5Tuw
# YDpeI+Ll8ZH19MkzQ3ONi3iz/gwZqJWbU5h4zRga+9YCT+O7wiosflMp1Ie5nxwn
# rrTcX6tDTXt1VEHXQWNDWrcZk6rqxVrBZujWTR3AivPI0zRdh9Cvh4rhlcmHtEF/
# JYhXpxE74fsv1JAHW9hzVoNwEgiJYU1OVGiDcfzHF7bGDTO4o/EGvnTqSrIQONhe
# 8mKBGyeJmdyaXFNaAVCojY+PguwN+ybgm0S81jVLM//Kdv2sOo/QWC/hKh3EzQ0W
# dshMat//N+YczPhzRTekK0EofSi2u3wL5eCSHznTYRf332VlZuF2TAAQo6jzxRia
# ZVz4oYIDIDCCAxwGCSqGSIb3DQEJBjGCAw0wggMJAgEBMHcwYzELMAkGA1UEBhMC
...
# 9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTI1MDUxMjE3MjYxOVowLwYJKoZIhvcNAQkE
# MSIEIOuALNmgBeznF7KkJQ/GQLgG7/BWZww8b5yzrEIoX/BpMA0GCSqGSIb3DQEB
# AQUABIICAG+qYxr6+6mUrixZJc2pMnlkN+tMYfhIcebKgd8VQc0sO1GmPBYZI979
# pZL6xnAct6G4CHMfGHnpLklnZy3HO5FEK8Bj4tGyT69ubGx7ILGlm43gbsbvMc3N
# 3GJOKY8xs+xQtAaX/dhN5OP3kskBd3X71Eeu7+PWgofqrk9AcZ0deTh+W24SizJF
# wuBw7qQV0rLkbWirqm05abcUmgOvXcWvevnDJ5+WOslHf5+nlQLD1OjQdvEYKJR+
# +Tzl8rBeHOuyIExA7jx1DzNRGB5DTefSVUJ04Sdj+HPVh66HzJPa1rrfiHLsybci
# jD/1PieL/XJmYJX+5x0Ez7akyqGm1j2PLtikJ8t6VoGIhjaeKg4J4mJHlxIN9X4a
# F9zTd+ae4vPDkSfrdao2Xv1jqjlfbwxD0l6epK5VkAHQgfhm85X4FUMZEx5tYT1Y
# K1J4P4BR+1m2MgEb9HGNtzRze2aoEmDUPOo5KfJUIfjNc1kJAA+o5EM7b+eyVb5p
# hzrdyodCYsSQKUtB9ITxl7lYY4mlJvLxqq6uhxOtpAZ3b8Hf//HnPbHLyNc74igd
# vdX0sWhVqh3O+xwKr/9JyxLzO2+hdtM0ZOGyMSluxCtMVDUNU9WIUOrSWlVOxf8P
# G7F+dZub5wdFAEj9FBA286lxCCdCUyExRhj8oTDjDIQHMncKncBQ
